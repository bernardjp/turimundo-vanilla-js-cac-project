...
<h1>Key Features.</h1>
<p>This site its just a mock of a real e-commerce and it lacks the functionality usually associated with this kind of sites. The purpouse of this project is to showcase the behavior of its various pages and components (responsive design, animations, dynamic rendering, etc.).</p>
<ul>
